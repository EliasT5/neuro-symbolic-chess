...
Some models in our roster (Opus 4.7, Sonnet 4.6, Model-G 3 Pro,
Model-O 5.5, Model-O 5.3 Model-X) support extended thinking natively via a
provider-specific API parameter. Others (Lite-C 4.5, Model-G Lite-G Lite,
Model-O 5.4 Mini) do not. To compare apples to apples in the tournament,
