...
Architecture note:
    The actual model invocation (`dispatch_to_model`, Model-O/Model-C
    ...
    Model-C-driven dispatch (one game at a time) or a script-based
...
@dataclass
class GameSession:
    """Lives across turns when Model-C is the dispatch driver. Persistable."""
